...
/**
 * PURE FUNCTION: Generates concise status bar text for display.
 * 
...
/**
 * PURE FUNCTION: Determines status bar color based on usage level.
 * 
...
/**
 * PURE FUNCTION: Formats detailed usage information for tooltips and dialogs.
 * 
...
/**
 * PURE FUNCTION: Formats comprehensive time-related information for detailed views.
 * 
